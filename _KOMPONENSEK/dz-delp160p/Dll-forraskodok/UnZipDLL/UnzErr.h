...
#ifdef NO_CONSTS
 const char CentSigMsg[] = "error:  expected central file header signature not found (file #%u).\n";
 const char EndSigMsg[] = "\nnote: didn't find end-of-central-dir signature at end of central dir.\n";
 const char SeekMsg[] =	"error [%s]:  attempt to seek before beginning of zipfile\n%s";
 const char FilenameNotMatched[] = "caution: filename not matched:  %s\n";
 const char ExclFilenameNotMatched[] = "caution: excluded filename not matched:  %s\n";
#endif

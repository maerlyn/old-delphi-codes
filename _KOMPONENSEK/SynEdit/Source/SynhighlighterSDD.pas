...
$Id: SynhighlighterSDD.pas,v 1.1 2001/08/21 13:45:25 jjans Exp $
...
begin
  if KeyComp('longint') then Result := tkKey else Result := tkIdentifier;
end;

function TSynSDDSyn.Func95: TtkTokenKind;
begin
  if KeyComp('binarydata') then Result := tkKey else Result := tkIdentifier;
end;

...
$Id: SynHighlighterSQL.pas,v 1.11 2001/08/15 05:34:43 jjans Exp $
...
type
  TtkTokenKind = (tkComment, tkDatatype, tkDefaultPackage, tkException,         // DJLP 2000-08-11
    ...
    tkSQLPlus, tkString, tkSymbol, tkUnknown, tkVariable);                      // DJLP 2000-08-11
...
{begin}                                                                         // DJLP 2000-09-05
  ...
  OracleKW: string =
    ...
    'EVENTS,EXCEPT,EXCEPTIONS,EXCHANGE,EXCLUDING,EXCLUSIVE,EXEC,EXISTS,' +
  ...
  OraclePLSQLKW: string =
    ...
    'DISPOSE,DO,EACH,ELSIF,END,ENTRY,EXCEPTION,EXCEPTION_INIT,EXECUTE,EXIT,' +
    'EXTERNAL,FALSE,FETCH,FIXED,FORALL,FORM,FOUND,FUNCTION,GENERIC,GOTO,IF,' +
    'INDEXES,INDICATOR,INSTEAD,INTERFACE,ISOPEN,LANGUAGE,LIMITED,LOOP,MAXLEN,' +
    'NAME,NEW,NEXTVAL,NOTFOUND,NUMBER_BASE,OLD,OPEN,OUT,PACKAGE,' +
    'PARALLEL_ENABLE,PARTITION,PASCAL,PRAGMA,PRIVATE,PROCEDURE,RAISE,RANGE,' +
    'RECORD,REF,REFERENCING,RELEASE,REMR,RESTRICT_REFERENCES,RETURN,REVERSE,' +
    'ROLLBACK,ROWCOUNT,ROWTYPE,RUN,SAVEPOINT,SCHEMA,SELF,SEPARATE,' +
    'SERIALLY_REUSABLE,SPACE,SQL,SQLERROR,STATEMENT,STRUCT,SUBTYPE,TABAUTH,' +
    'TABLES,TASK,TDO,TERMINATE,TRUE,TYPE,USE,VARYING,VIEWS,WHEN,WHILE,WORK,' +
    'WRITE,XOR';
  ...
  OracleSQLPlusCommands: string =
   'ARCHIVE,ATTRIBUTE,BREAK,BRE,BTITLE,BTI,CL,CLEAR,COMP,CONN,COPY,DEFINE,' +
   'DEF,DESCRIBE,DESCRIB,DESCRI,DESCR,DESC,DISCONNECT,DISCONNEC,DISCONNE,' +
   'DISCONN,DISCON,DISCO,DISC,HELP,OSERROR,PRINT,PRI,PROMPT,REPFOOTER,REPF,' +
   'REPHEADER,REPH,SET,SHOW,SHO,SHUTDOWN,STARTUP,TIMING,TIMI,TTITLE,TTI,' +
   'UNDEFINE,UNDEF,VARIABLE,VAR,WHENEVER';

...
$Id: SynhighlighterCPM.pas,v 1.3 2001/08/21 13:42:18 jjans Exp $
...
Type
  ...
  TRangeState = (rsBraceComment, rsRoundComment, rsUnKnown);
...
procedure TSynCPMSyn.RoundOpenProc;
begin
  Inc(Run);
  case fLine[Run] of
    '*':
...
begin
  ...
  case fRange of
    ...
    rsRoundComment: RoundCommentProc;
  else
...
procedure TSynCPMSyn.RoundCommentProc;
begin
  case fLine[Run] of
     #0: NullProc;
    #10: LFProc;
...
procedure TSynCPMSyn.SlashProc;
begin
  Inc(Run);
  if (fLine[Run] = '/') then
  begin

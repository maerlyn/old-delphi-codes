...
$Id: SynHighlighterMPerl.pas,v 1.3 2001/05/31 12:07:07 claplace Exp $
...
begin
   ...
   while true do begin
      ...
      if not (GenIdentArray[FCurrentLine[i]] in [gltSpaces,gltCRLFNULL]) then break;
      Dec(i);
   end;
   // first non-space character was found
   case FCurrentLine[i] of
       // Maybe we found tail of function or variable or number
       'a'..'z','A'..'Z','_','0'..'9' : begin
                                           j:=i;
                                           while true do begin
                                              if not (FCurrentLine[j] in
                                           ...
                                           case CalcCRC32(FCurrentLine+j,i-j+1) of
                                              $77D76D0C{split},$10EE1483{if},$8F1F1E9D{unless},$1034D0EA{for},$667B720C{elsif},$06F6A2E0{while},$DA8200D7{foreach} : begin
                                                        Inc(FCurrentLineOffset);

...
$Id: SynHighlighterMulti.pas,v 1.5 2001/05/31 12:07:07 claplace Exp $
...
uses
  SynRegExpr, SysUtils, SynEditStrConst,
  {$IFDEF SYN_KYLIX}
  QGraphics;
  {$ELSE}
  Graphics;
...
function TSynMultiSyn.GetDefaultAttribute(Index: integer):

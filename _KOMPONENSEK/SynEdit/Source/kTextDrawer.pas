...
$Id: kTextDrawer.pas,v 1.2 2001/05/28 00:00:59 dparnell Exp $
...
begin
  ...
  if CaretManager.CurrentCaret=aCaret then
...
begin
  ...
  try
    fCharWidth := QFontMetrics_width(fm, 'W');

...
$Id: SynEditReg.pas,v 1.7 2001/08/21 13:43:15 jjans Exp $
...
// SynEdit highlighters
  ...
  SynHighlighterJScript, SynHighlighterKix, SynHighlighterModelica,
  SynHighlighterM3, SynHighlighterPas, SynHighlighterPerl, SynHighlighterPHP,
  SynHighlighterProgress, SynHighlighterPython, SynHighlighterSml,
  SynHighlighterSql, SynHighlighterTclTk, SynHighlighterVB,
  SynHighlighterVBScript, SynHighlighterGWS, SynHighlighterCPM,
  SynHighlighterSDD;
...
// SynEdit highlighters
  RegisterComponents(SYNS_HighlightersPage, [
    ...
    // other
    TSynBaanSyn, TSynGalaxySyn, TSynProgressSyn, TSynCPMSyn
  ]);
end;

...
$Id: SynHighlighterManager.pas,v 1.3 2001/08/01 17:33:57 jrx Exp $
...
uses
  SysUtils,
  {$IFDEF LINUX}
  Qt, QForms, QControls, QStdCtrls, QCheckLst,
  {$ELSE}
  {$IFDEF SYN_COMPILER_6_UP} DesignIntf, {$ELSE} DsgnIntf, {$ENDIF}
  Windows, Forms, Controls, StdCtrls, CheckLst,
  {$ENDIF}

...
var
  ...
  wglUseFontOutlinesA: function (p1: HDC; p2, p3, p4: DWORD; p5, p6: Single; p7: Integer;
    p8: PGlyphMetricsFloat): BOOL; stdcall;
  wglUseFontBitmapsW: function(DC: HDC; p2, p3, p4: DWORD): BOOL; stdcall;
  wglUseFontOutlinesW: function (p1: HDC; p2, p3, p4: DWORD; p5, p6: Single; p7: Integer;
    p8: PGlyphMetricsFloat): BOOL; stdcall;
  wglUseFontBitmaps: function(DC: HDC; p2, p3, p4: DWORD): BOOL; stdcall;
  wglUseFontOutlines: function(p1: HDC; p2, p3, p4: DWORD; p5, p6: Single; p7: Integer;
    p8: PGlyphMetricsFloat): BOOL; stdcall;
...
begin
  ...
  begin
    ...
    wglSwapMultipleBuffers := GetProcAddress(GLHandle, 'wglSwapMultipleBuffers');
...
begin
  ...
  begin
    ...
    if not wglMakeCurrent(DC, RC) then
      raise EMakeCurrentFaileException.Create(Format('wglMakeCurrent failed: DC=%d, RC=%d', [DC, RC]));

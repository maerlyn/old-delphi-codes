...
const
  ...
  SQLStringSym = 4;  COUNTSym = 5;  _lparenSym = 6;  _starSym = 7;
  _rparenSym = 8;  MINSym = 9;  MAXSym = 10;  SUMSym = 11;  AVGSym = 12;
  _commaSym = 13;  ORSym = 14;  ANDSym = 15;  NOTSym = 16;  _equalSym = 17;
  _less_equalSym = 18;  _lessSym = 19;  _greaterSym = 20;
  _greater_equalSym = 21;  _less_greaterSym = 22;  ISSym = 23;  NULLSym = 24;
  TRUESym = 25;  FALSESym = 26;  UNKNOWNSym = 27;  BETWEENSym = 28;
  LIKESym = 29;  ESCAPESym = 30;  INSym = 31;  _plusSym = 32;  _minusSym = 33;
  _bar_barSym = 34;  _slashSym = 35;  CASESym = 36;
  CHARACTER_underscoreLENGTHSym = 37;  CHAR_underscoreLENGTHSym = 38;
  LOWERSym = 39;  UPPERSym = 40;  POSITIONSym = 41;  SUBSTRINGSym = 42;
  FROMSym = 43;  FORSym = 44;  TRIMSym = 45;  LEADINGSym = 46;
  TRAILINGSym = 47;  BOTHSym = 48;  FORMATNUMBERSym = 49;
  FORMATDATETIMESym = 50;  INTTOHEXSym = 51;  EXTERNSym = 52;  ELSESym = 53;
  ENDSym = 54;  WHENSym = 55;  THENSym = 56;  DATESym = 57;  TIMESym = 58;
  TIMESTAMPSym = 59;  NOSYMB = 60;  _noSym = NOSYMB;   {error token code}
...
procedure TOvcRvExp._BooleanLiteral (Parent:  TOvcRvExpNode;  var  BooleanLiteral:  TOvcRvExpBooleanLiteral);begin
...
procedure TOvcRvExp._TimestampLiteral (Parent:  TOvcRvExpNode;
var  TimestampLiteral:  TOvcRvExpTimestampLiteral);begin
...
procedure TOvcRvExp._TimeLiteral (Parent:  TOvcRvExpNode;
var  TimeLiteral:  TOvcRvExpTimeLiteral);begin
...
procedure TOvcRvExp._DateLiteral (Parent:  TOvcRvExpNode;
var  DateLiteral:  TOvcRvExpDateLiteral);begin
...
procedure TOvcRvExp._StringLiteral (Parent:  TOvcRvExpNode;
var  StringLiteral:  TOvcRvExpStringLiteral);begin
StringLiteral  :=  TOvcRvExpStringLiteral.Create(Parent);
Expect(SQLStringSym);
StringLiteral.Value  :=  LexString;
end;

procedure TOvcRvExp._IntegerLiteral (Parent:  TOvcRvExpNode;
var  IntegerLiteral:  TOvcRvExpIntegerLiteral);begin
IntegerLiteral  :=  TOvcRvExpIntegerLiteral.Create(Parent);
Expect(integer_Sym);
IntegerLiteral.Value  :=  LexString;
end;

procedure TOvcRvExp._FloatLiteral (Parent:  TOvcRvExpNode;
var  FloatLiteral:  TOvcRvExpFloatLiteral);begin
FloatLiteral  :=  TOvcRvExpFloatLiteral.Create(Parent);
Expect(floatSym);
FloatLiteral.Value  :=  LexString;
end;

procedure TOvcRvExp._WhenClause (Parent  :  TOvcRvExpNode;
var  WhenClause  :  TOvcRvExpWhenClause);var  CondExp  :  TOvcRvExpression;
...
procedure TOvcRvExp._WhenClauseList (Parent:  TOvcRvExpNode;
var  WhenClauseList  :  TOvcRvExpWhenClauseList);var  WhenClause  :  TOvcRvExpWhenClause;
begin
...
procedure TOvcRvExp._CaseExpression (Parent:  TOvcRvExpNode;
var  CaseExp:  TOvcRvExpCaseExpression);var  WhenClauseList  :  TOvcRvExpWhenClauseList;
...
CaseExp.ElseExp  :=  Exp;
end else begin SynError(63);
end;
end;
Expect(ENDSym);
end;

procedure TOvcRvExp._ScalarFunction (Parent:  TOvcRvExpNode;
var  Func:  TOvcRvExpScalarFunc);var  CondExp:  TOvcRvExpression;
var  Exp  :  TOvcRvExpSimpleExpression;
...
else begin SynError(64);
    end;
end;
end;

procedure TOvcRvExp._Literal (Parent:  TOvcRvExpNode;
var  Literal:  TOvcRvExpLiteral);var  FloatLiteral  :  TOvcRvExpFloatLiteral;
var  IntegerLiteral  :  TOvcRvExpIntegerLiteral;
var  StringLiteral  :  TOvcRvExpStringLiteral;
var  DateLiteral  :  TOvcRvExpDateLiteral;
var  TimeLiteral  :  TOvcRvExpTimeLiteral;
...
procedure TOvcRvExp._Factor (Parent:  TOvcRvExpNode;
var  Factor  :  TOvcRvExpFactor;
MulOp:  TOvcRvExpMulOp);var  FieldRef  :  TOvcRvExpFieldRef;
var  CondExp  :  TOvcRvExpression;
var  Literal  :  TOvcRvExpLiteral;
...
procedure TOvcRvExp._Term (Parent:  TOvcRvExpNode;  var  Term  :  TOvcRvExpTerm;  AddOp  :  TOvcRvExpAddOp);var  Factor  :  TOvcRvExpFactor;
...
procedure TOvcRvExp._SimpleExpressionList (Parent:  TOvcRvExpNode;
var  SimpleExpressionList:  TOvcRvExpSimpleExpressionList);var  SimpleExpression  :  TOvcRvExpSimpleExpression;
begin
...
procedure TOvcRvExp._IsTest (Parent:  TOvcRvExpNode;
var  IsTest:  TOvcRvExpIsTest);begin
Expect(ISSym);
...
procedure TOvcRvExp._LikeClause (Parent:  TOvcRvExpNode;
var  LikeClause:  TOvcRvExpLikeClause;
Negated:  Boolean);var  SimpleExpression  :  TOvcRvExpSimpleExpression;
begin
...
procedure TOvcRvExp._InClause (Parent:  TOvcRvExpNode;
var  InClause:  TOvcRvExpInClause;
Negated:  Boolean);var  SimpleExpressionList  :  TOvcRvExpSimpleExpressionList;
begin
...
procedure TOvcRvExp._BetweenClause (Parent:  TOvcRvExpNode;
var  BetweenClause:  TOvcRvExpBetweenClause;
Negated:  Boolean);var  SimpleExpression  :  TOvcRvExpSimpleExpression;
begin
...
procedure TOvcRvExp._CondPrimary (Parent:  TOvcRvExpNode;
var  CondPrimary  :  TOvcRvExpCondPrimary);var  SimpleExpression  :  TOvcRvExpSimpleExpression;
...
procedure TOvcRvExp._CondFactor (Parent:  TOvcRvExpNode;
var  CondFactor:  TOvcRvExpCondFactor);var  CondPrimary  :  TOvcRvExpCondPrimary;
begin
...
procedure TOvcRvExp._CondTerm (Parent:  TOvcRvExpNode;
var  CondTerm  :  TOvcRvExpCondTerm);var  CondFactor  :  TOvcRvExpCondFactor;
begin
...
procedure TOvcRvExp._CondExpList (Parent:  TOvcRvExpNode;
           var  CondExpList:  TOvcRvExpressionList);var  CondExp  :  TOvcRvExpression;
begin
...
procedure TOvcRvExp._FieldRef (Parent:  TOvcRvExpNode;  var  FieldRef:  TOvcRvExpFieldRef);begin
FieldRef  :=  TOvcRvExpFieldRef.Create(Parent);;
Expect(identSym);
FieldRef.FieldName  :=  LexString;
end;

procedure TOvcRvExp._SimpleExpression (Parent:  TOvcRvExpNode;
var  SimpleExpression  :  TOvcRvExpSimpleExpression);var  Term  :  TOvcRvExpTerm;
...
procedure TOvcRvExp._Aggregate (Parent:  TOvcRvExpNode;  var  Aggregate  :  TOvcRvExpAggregate);var  SimpleExpression  :  TOvcRvExpSimpleExpression;
begin
...
procedure TOvcRvExp._CondExp (Parent:  TOvcRvExpNode;
var  CondExp:  TOvcRvExpression);var  CondTerm  :  TOvcRvExpCondTerm;
begin
...
procedure TOvcRvExp._OvcRvExp;var  Expression  :  TOvcRvExpression;
begin
Init;

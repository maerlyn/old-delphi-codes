 ...
 *)
procedure Sound_GetLinkedVersion(ver: PSound_Version); cdecl; external
LibName;
 ...
 *)
function Sound_Init: integer; cdecl; external
LibName;
 ...
 *)
function Sound_Quit: integer; cdecl; external
LibName;
 ...
 *)
function Sound_AvailableDecoders: PSound_DecoderInfo; cdecl; external
LibName;
 ...
 *)
function Sound_GetError: PChar; cdecl; external
LibName;
 ...
 *  return nil.
 *)
procedure Sound_ClearError; cdecl; external
LibName;
...
function Sound_NewSample(rw: PSDL_RWops; const ext: PChar;
  desired: PSound_AudioInfo; bufferSize: Uint32): PSound_Sample; cdecl; external
LibName;
...
function Sound_NewSampleFromFile(const filename: PChar; desired:
  PSound_AudioInfo; bufferSize: Uint32): PSound_Sample; cdecl; external
LibName;
 ...
 *)
procedure Sound_FreeSample(sample: PSound_Sample); cdecl; external
LibName;
 ...
 *)
function Sound_Decode(sample: PSound_Sample): Uint32; cdecl; external
LibName;
 ...
 *)
function Sound_DecodeAll(sample: PSound_Sample): Uint32; cdecl; external
LibName;
 ...
 *           error can be gleaned from Sound_GetError.
 *)
function Sound_Rewind(sample: PSound_Sample): integer; cdecl; external
LibName;

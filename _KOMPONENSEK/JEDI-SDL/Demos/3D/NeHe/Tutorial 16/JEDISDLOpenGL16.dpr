...
var
  ...
  texture : array[ 0..NUM_TEXTURES - 1 ] of TGLuint; // Storage For 3 Textures ( NEW )

  // Storage For Three Types Of Fog */
  fogMode : array[0..2] of TGLuint = ( GL_EXP, GL_EXP2, GL_LINEAR );
  // Which Fog To Use
  fogFilter : TGLuint = 0;
  // Fog Color
  fogColor: array[0..3] of TGLfloat = (0.5, 0.5, 0.5, 1.0);

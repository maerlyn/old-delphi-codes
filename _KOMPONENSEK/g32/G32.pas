...
{*********************************************}
// $Id: G32.pas,v 1.3 2001/09/17 22:22:11 alex Exp $
...
{$IFNDEF DELPHI6}function Rect(L, T, R, B: Integer): TRect; overload;{$ENDIF}
...
begin
  ...
  BlockTransfer(Dst, 0, 0, Self, Rect(0, 0, Width, Height), DrawMode, FOnPixelCombine);
  Dst.Changed;
end;
...
begin
  if Empty or Dst.Empty then Exit;
  BlockTransfer(Dst, DstX, DstY, Self, Rect(0, 0, Width, Height), DrawMode, FOnPixelCombine);
  Dst.Changed;
end;

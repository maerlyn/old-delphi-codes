 ...
 PaintBox1.Canvas.Font.Color := frmMainForm.Betuk;
  ...
  for i := 0 to 350 + LineH * 13 do
   ...
   begin
    ...
    TextOut(40,350 + LineH * 10 - I,'                                               ');
    TextOut(40,350 + LineH * 11 - I,'Az eltûnési effekt Papp Miklóstól, a           ');
    TextOut(40,350 + LineH * 12 - I,'CheatCodeX készítõjétõl származik.             ');
    TextOut(40,350 + LineH * 13 - I,'http://cheatcodex.com                         ');
    Delay(0,vg);
    if Vege then
    begin
     Exit;

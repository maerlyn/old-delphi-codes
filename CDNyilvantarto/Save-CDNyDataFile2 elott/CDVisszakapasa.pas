...
uses
  ...
  StdCtrls, IniFiles, ExtCtrls, Printers, ButtonWithColor, CDNyDataFile;
...
begin
 ...
 for i := 1 to CDNyDataFile_CDk1.Mennyiseg do
  if CDNyDataFile_CDk1.GetIndex(i).CDNeve = CDNeve then
   j := i;
 CDNyDataFile_CDk1.SetIndex(j,cKolcsonVanEKerve,false);
...
//    Image1.Picture.Bitmap.LoadFromFile(ExtractFilePath(ParamStr(0)) + 'szamla.bmp');
    ...
    for j := 1 to CDNyDataFile_Kolcsonkerok1.Mennyiseg do

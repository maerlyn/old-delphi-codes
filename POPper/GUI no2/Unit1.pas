...
begin
 ...
 if (ListView1.Items.Count = 0)and(WebBrowser1.LocationURL <> 'about:MoZilla') then
...
begin
 ...
 if (ListView2.Items.Count = 0)and(WebBrowser2.LocationURL <> 'about:MoZilla') then
  WebBrowser2.Navigate('about:MoZilla');
...
begin
 ...
 begin
  FirstShow := false;
   WebBrowser1.Navigate('about:MoZilla');
   WebBrowser2.Navigate('about:MoZilla');
   WebBrowser3.Navigate('about:MoZilla');
 end;
end;
...
begin
 ...
 if (ListView3.Items.Count = 0)and(WebBrowser3.LocationURL <> 'about:MoZilla') then
  WebBrowser3.Navigate('about:MoZilla');
...
// if (URL <> 'about:MoZilla')and(URL <> ExtractFilePath(ParamStr(0)) + 'temp.htm') then
//  Cancel := true;
...
begin
 txtLevelekellenorzese.Enabled := cbxLevelekellenorzese.Checked;
end;
...
procedure TfrmMainForm.MinimizeToTray;
begin
 ...
 nid.hIcon := LoadIcon(hInstance,'PWICON_SMALL');
 StrPCopy(nid.szTip,frmMainForm.Caption);
